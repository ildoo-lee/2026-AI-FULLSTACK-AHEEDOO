...
CREATE TABLE `dept` (
  ...
  `dname` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `loc` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`deptno`)
...
INSERT INTO `mvcboard1` VALUES (7,'둘리','1111','둘리','둘리','2026-05-26 02:19:28',2,'192.168.40.9'),(8,'마이콜','1111','마이콜','마이콜','2026-05-26 02:19:44',3,'192.168.40.9'),(9,'희동이','1111','희동이','희동이','2026-05-26 02:20:03',1,'192.168.40.9'),(10,'또치','1111','또치','또치','2026-05-26 02:20:54',1,'192.168.40.9'),(11,'도우너','1111','도우너','도우너','2026-05-26 02:21:13',5,'192.168.40.9');
...
INSERT INTO `users` VALUES (1,'aaa','1111','aaa@gmail.com','010-1111-1111','2026-05-26 09:13:53','192.168.0.1'),(2,'bbb','2222','bbb@gmail.com','010-2222-2222','2026-05-26 15:54:10','192.168.0.101');
...
-- Dump completed on 2026-05-27  1:38:37
