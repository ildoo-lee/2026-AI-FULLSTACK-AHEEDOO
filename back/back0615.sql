...
INSERT INTO `authorities` VALUES ('first@gmail.com','ROLE_MEMBER'),('a@a','ROLE_MEMBER'),('a@a','ROLE_ADMIN'),('b@b','ROLE_MEMBER'),('c@c','ROLE_MEMBER'),('d@d','ROLE_MEMBER'),('d@d','ROLE_MEMBER'),('d@d','ROLE_MEMBER'),('d@d','ROLE_MEMBER'),('h@h','ROLE_MEMBER'),('i@i','ROLE_MEMBER'),('j@j','ROLE_MEMBER');
...
CREATE TABLE `t2` (
  `ino` int NOT NULL,
  PRIMARY KEY (`ino`),
  CONSTRAINT `t2_ibfk_1` FOREIGN KEY (`ino`) REFERENCES `t1` (`no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t4` (
  `ino` int NOT NULL,
  PRIMARY KEY (`ino`),
  CONSTRAINT `t4_ibfk_1` FOREIGN KEY (`ino`) REFERENCES `t3` (`no`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-06-15 17:56:13
