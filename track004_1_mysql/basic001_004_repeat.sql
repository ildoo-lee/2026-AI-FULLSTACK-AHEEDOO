...
-- DML( 조작어  )    __insert______, ____select____, ____update____ , ____delete____ 
-- DCL(  제어어  )     ___grant_____, ___revoke_____
...
drop table userinfo;  -- 테이블 있다면 삭제시
...
alter table userinfo modify email2 varchar(50); 
