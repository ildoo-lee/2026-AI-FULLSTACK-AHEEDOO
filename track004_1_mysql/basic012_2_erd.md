...
ex1) 하나의 A는 여러개ㅇ의 B로 구성되어있다.
한명의 학생은 여러개의 수강내역을 가진다.
[홍길동] ┼───∈ [JAVA, JSP, SPRING, MYSQL]

■3. 점선  VS  실선
실선 : 부모테이블의 기본키르 자식테이블의 기본키로 사용
점선 : 부모테이블의 기본키르 자식테이블의 기본키로 사용 안한 경우
...
풀이3) 실선(부모테이블 PK - 자식테이블 PK) , 점선(qnahxpdlqmf PK - 자식테이블 FK)
