...
insert into userinfo (name, age) values(22,'bbb');
-- 10:41:25	insert into userinfo (name, age) values(22,'bbb')	
-- Error Code: 1366. Incorrect integer value: 'bbb' for column 'age' at row 1	0.000 sec
-- Incorrect inteser value: 'bbb' for column 'age' at row 1 0.00 sec
...
SET SQL_SAFE_UPDATES=0; -- 안쓸래
delete from userinfo;
-- 11:43:19	delete from userinfo	
...
-- 1. 테이블 복사해오기 #Q  userinfo  구조+데이터 복사해서
-- >  2. 업데이트 (update) 
-- ------------------------------------------------------------
-- UPDATE 테이블 이름
...
update userinfo set age=44 , name='fourth'   where no=4 and name='first';
-- 조건에 안맞으면 업데이트 안됨
update userinfo set age=44 , name='fourth'   where no=4;
select * from userinfo;
...
create table update_score select * from score;
desc score;
create table update_score sno int(11) not null primary key auto_increment;
desc update_score;
...
-- +-----+-------+-------+------+---------+----------+---------+-------+--------+
insert into update_score values ( 1 , 'aaa'   ,   100 ,  100 ,     100 ,      100 ,    NULL ,  NULL , NULL );
insert into update_score values (  2 , 'bbb'   ,    90 ,   98 ,      88 ,      100 ,    NULL ,  NULL , NULL);
insert into update_score values ( 3 , 'ccc'  ,    70 ,   20 ,      78 ,       80 ,    NULL ,  NULL , NULL);
insert into update_score values ( 4 , 'ddd'   ,    78 ,   89 ,      68 ,       98 ,    NULL ,  NULL , NULL );
insert into update_score values (  5 , 'abc'   ,    89 ,   98 ,      69 ,       77 ,    NULL ,  NULL ,NULL  );
select * from update_score;

-- [001]   이름이 ccc인 사람의 sjava=90 , sjsp=90, sspring=90으로 수정하시오
update update_score set sjava = 90 , sjsp = 90 , sspring = 90     where sname='ccc'; 

-- [002]  모든학생의 semail의 값을 admin@gamil.com으로 수정하시오
update update_score set semail = 'admin@gmail.com'; 

-- [003]  성적의 총합(sstotal)을 계산해서 넣기   sjava+sjsp+sspring+sproject
update update_score set stotal = sjava + sjsp + sspring + sproject;  

-- [004]  성적의 평균을 계산해서 넣기 , ssavg = sstotal/4
update update_score set  ssavg = stotal/4;
 
select * from update_score;

-- [005]  성적의 평균이 ssavg 100점인 학생의 email을 first@gmail.com으로 수정하시오
update update_score set semail = 'first@gmail.com' where ssavg = 100;
 
-- [006]  이름이 bbb인 학생의 sjava 점수를 92 , sjsp점수를 78로 , 총점, 평균을  수정하시오
update update_score 
set sjava = 92 , sjsp = 78 
where sname = 'bbb';
 
-- [007]  성적의 평균이 ssavg 89.5점인 학생의 semail을 second@gmail.com로 , sname을 second로 수정하시오
update update_score set semail = 'second@gmail.com' , sname = 'second'  where ssavg = 94;

-- [008]   sname이 ccc인 학생의 semail을  ccc@gmail.com으로 수정하시오
update update_score set semail = 'ccc@gmail.com' where sname = 'ccc'; 

-- [009]   sproject점수가 80점미만인 학생의 semail을 blackstdudent@gmail.com으로 수정하시오
update update_score set semail ='blackstdudent@gmail.com' where sproject < 80;

 
-- [010]   ssavg이89.5이고 sproject가 98인 학생의 semail을  hello@gmail.com으로 수정하시오
update update_score set semail ='hello@gmail.com' where ssavg = 94 and sproject = 98; 
...
-- --------------------------------------------------
-- >  #  userinfo 테이블복사해서userinfouserinfo
