            ...
            System.out.println(
             "🌟💰 WELCOME TO BANK SYSTEM 💰🌟\n" 
                   ...
                   for(int j =0;j<=id.length;j++) {
                      if(!(id[j] == tid && pass[j] == tpass)) {System.out.println("없는 정보이니, 다시 입력해주세요");continue;}
                         
                         switch(menu) {
                            case 2 : System.out.println("잔액:"+ balance[j] + "원입니다");break;
                            case 3 : System.out.print("입금할 금액을 입력하세요"); us = scanner.nextDouble();
                                   balance[j] = balance[j] + us;  
                                   System.out.println("잔액:"+ balance[j] + "원입니다");break;
                            case 4 : System.out.print("출금할 금액을 입력하세요"); us = scanner.nextDouble();
                                     balance[j] = balance[j] - us; 
                                     System.out.println("잔액:"+ balance[j] + "원입니다");break;
                            case 5 : id[j] = ""; pass[j] = ""; balance[j] = -1;
