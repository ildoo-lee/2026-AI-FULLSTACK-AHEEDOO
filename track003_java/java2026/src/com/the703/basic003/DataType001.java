...
public class DataType001 {
	...
	public static void main(String[] args) {
		...
		// byte hap = by+1; // 오류. 왜? byte(1) + int(4)
		int hap = by+1; // int로 바꾸면 오류 안난다.
		System.out.println("2. 정수 : byte - shot - int★ - long");
		
		// 2-3 실수형 : (float(F)-doule★ / 3.14 / 4-8)
		...
		float fp3 = 1.11111111f; // 1 7개 + 1 = 8개 -> 근사값
		System.out.println(fp1 + "\t" +fp2 + "\t" + fp3);		
		
		// 1.0000001	1.0	     1.1111112
		double dp1 = 1.000000000000001;  // 0이 14개 + 1 = 15개 -> 정확하게 표현
		double dp2 = 1.0000000000000001;  // 0이 15개 + 1 = 15개 -> 정밀도 초과 반올림
		double dp3 = 1.1111111111111111;  // 1이 15개 + 1 = 15개 -> 근사
