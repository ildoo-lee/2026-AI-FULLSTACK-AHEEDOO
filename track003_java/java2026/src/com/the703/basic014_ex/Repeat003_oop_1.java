...
class Papa3{
	...
	public Papa3() { super(); }
	public Papa3(int money) { super(); this.money = money; }
	@Override public String toString() { return "Papa [money=" + money + "]"; }
}
class Son3 extends Papa3{
	int money=150;
	int car=2;
	
	public Son3() { super(); }
	public Son3(int money) { super(money); }
	public Son3(int money, int car) { super(); this.money = money; this.car = car; }
	@Override public String toString() { return "Son [money=" + money + ", car=" + car + "]"; }
}
 


public class Repeat003_oop_1 {
