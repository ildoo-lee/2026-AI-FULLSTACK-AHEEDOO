...
public class LambdaEx002 {
    public static void main(String[] args) {
        ...
        // 2. 람다식 
    	StringLength sl2 = s -> { // sl2 = s -> s.length(); 
				return s.length(); 
				};
        ...
        StringCompare sc2 = ( a,  b) -> { return a.compareTo(b); };
        System.out.println("익명객체 결과: " + sc2.compare("apple", "banana")); // -1
        ...
        System.out.println("익명객체 결과: " + sc3.compare("apple", "banana"));
