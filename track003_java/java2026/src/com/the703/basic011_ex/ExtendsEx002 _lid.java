...
class MobileNote extends Object     {void show() {} }
...
class MobileNote8 extends MobileNote7{
	private String face;     
	// 오버라이딩은 상속시 부모의 메서드와 부모의 기능을 수정해 내것으로 만드는것 나에게 맞게 수정
