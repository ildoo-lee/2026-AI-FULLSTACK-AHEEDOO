...
class ZooKeeper{
	   public void show(Animal animal){
		    animal.sound(); // 공통 소리, 아래는 개별
	        if(animal instanceof Dog)  { ((Dog) animal).playFetch();} // 사운드 아닌것을 해야되는 상황이니 강제형변환 해야
...
public class InterfaceEx003 {
   public static void main(String[] args) {
     ...
     switch (choice) {
        ...
        case 2: animal = new Cat(); break; // 업케스팅
        case 3: animal = new Bird(); break; // 부모타입으로 메서드호실시 오버라이드된 최신 자식 메서드가 호출
