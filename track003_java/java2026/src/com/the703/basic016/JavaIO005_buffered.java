...
public class JavaIO005_buffered {
	public static void main(String[] args) throws IOException {
		...
		//2) new OutputStreamWriter(인코딩에 맞춰서 문자)
		//3) new BufferedWriter( 속도향상 ) (abc → abc_)
		BufferedWriter bw = 
...
-1) new FileStreamRdader(file) - byte  (0101....)
-2) new InputStreamReader      - 바이트를 [문자] 스트림으로, 인코딩
-3) new BufferedReader          - 속도향상, a → a(X), b → b(X) 아니고 abc → abc(O) 한꺼번에 
