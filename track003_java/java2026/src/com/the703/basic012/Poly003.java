...
public class Poly003 {
	...
	public static void main(String[] args) {
		System.out.println((int)1.1); // 소수점이 잘림
		
		TestB3 tb = (TestB3) new TestA3();
		//1) TestA3 ta { b = 20, toString} - { a = 10, toString }
...
/*
	    ...
	    at com.the703.basic012.Poly003.main(Poly003.java:31)
 */

/*
1. 다형성
- 많은 형상을 띄는 성품
- 여러타입의 객체를 하나의 타입으로 관리하는게 목적

2. 부모는 자식을 담을 수 있다. (업케스팅)
---------------------------------------------
<<class>> Animal [이름, 나이 / 먹기, 자기, 배변]
            ↑
<<class>>  Cat   [동물등록증 / 꾸꾹이 하기]

----------------------------------------------
Animal ani = new Cat()

1) Animal ani     { 이름, 나이 / 먹고, 자고, 배변 }
2)            Cat()   →    Animal()                 →  Object()
{동물등록증 / 꾹꾹이 하기} + {이름, 나이/ 먹기, 자기, 배견}            


3. 자식은 부모를 담을 수 있다.() 자식에 집중 (다운케스팅)
---------------------------------------------
<<class>> Animal [이름, 나이 / 먹기, 자기, 배변]
            ↓
<<class>>  Cat   [동물등록증 / 꾸꾹이 하기]
