...
// class Son extends Papa, Mana{} 자바에서의 상속은 단일상속. 그래서 Papa, Mana 둘은 안됨

interface Animal2{
	String company="(주) 메가스터디"; // company에 마우스키 대면, sf : static final - Animal2.company (클래스변수) method area, new X, this 각각X
