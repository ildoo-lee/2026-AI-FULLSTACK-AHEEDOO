...
public class SolidBasic {
	public static void main(String[] args) {
		...
		System.out.println("2. o : 개방폐쇄(레시피 추가) + l : 리스코프(공장- 어떤 쿠키든지 굽기 가능) 치환");
...
1. S : 한 클래스는 한가지 일만(예: 쿠키 반죽 클래스는 반죽만, 쿠기 굽기 클래스는 굽기만)
2. O : (수정은 말고, 추가 가능하게 해주세요) 새로운 쿠키 쉽게 추가 
3. L : (다형성 : 같은 방식으로 처리) 모든쿠키는 같은 방식으로 만들기
