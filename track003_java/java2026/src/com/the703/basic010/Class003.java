...
class Car32 extends Object{  //생성자는 초기화
	String color;   // alt + shift + s  - 끝에서 두번째     2,3,4

	public Car32() { color="white"; } // 기본 생성자  -  2) 생성자를 개발자 수동으로 만들때, 자동생성 취소
...
public class Class003 {
	...
	public static void main(String[] args) {
		Car31 car1 = new Car31(); // 1. new (객체생성) 2.Car31() 초기화  3. car1 번지@73a28541
		System.out.println(car1); // 지번@73a28541
...
- 개발자가 선언시 컴파일러가 자동생성을 취소하는 역할을 한다.
   alt+shift+s
