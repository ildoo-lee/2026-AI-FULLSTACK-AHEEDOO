...
public class BankProjectV1_lid_3 {
	...
	public static void main(String[] args) {
		...
		int menu = -1, id = -1, pass = -1, balance = -1, a = -1, tid = -1, tpass = -1;
		
			
//			 - 제어문 : if , switch
//			 - 반복문 : for(시작;  종료; 변화;), while(조건), do while(한번은 무조건 실행 맨끝에 조건)
			 
			  while( menu != 9 ) {System.out.print(
			       "🌟💰 WELCOME TO BANK SYSTEM 💰🌟\n" 
			             ...
			             if(menu == 1) {
			            	 ...
			            	 System.out.print("ID: "); tid = scanner.nextInt();
			            	 System.out.print("PW: "); tpass = scanner.nextInt();
			            	 
			            	 if(!(id == tid && pass == tpass)) {System.out.println("없는 정보이니, 다시 입력해주세요");continue;}
			            	 
			            	 switch(menu) {
				            	 case 2 : System.out.println("잔액:"+ balance + "원입니다");break;
				            	 case 3 : System.out.print("입금할 금액을 입력하세요"); a = scanner.nextInt();
							              balance = balance + a;  
							              System.out.println("잔액:"+ balance + "원입니다");break;
				            	 case 4 : System.out.print("출금할 금액을 입력하세요"); a = scanner.nextInt();
					                      balance = balance - a; 
					                      System.out.println("잔액:"+ balance + "원입니다");break;
				            	 case 5 : id = -1; pass = -1; balance = -1;
