...
public class SwitchEx006 {
	...
	public static void main(String[] args) {
		...
		// 입력
		System.out.println("요일 문자를 하나 입력해주세요");
		a = sc.next().charAt(0);
		//	a = sc.next();
		
		// 처리
		// 출력
		switch(a) { //switch(a.charAt(0)) {
			...
			case 'S' : case 's' : System.out.println("토요일: 휴식하는 날"); break;
			case 'U' : case 'u' : System.out.println("토요일: 휴식하는 날"); break;
