...
public class Method003_return {
	...
	//1. 함수구조 public static 리턴값(결과물)   메서드명(마법상자이름)(파라미터:재료){할 일}
	...
	public static void main(String[] args) {
		hello("aaa"); // 사용법 :  마법상자이름(재료)    hello("aaa");바로 다음 (1)이 들어감   
		...
		System.out.println("2. 당신의 소개는? "+intro("홍길동",9));  
		                  //2. 당신의 소개?     홍길동의 레벨은 9
		//public static String   intro("홍길동" , 9){홍길동님의 레벨은 9}
		System.out.println("2. 당신의 소개는? "+intro(sing(),10)); // 예상되는 결과는?
