...
<%@page import="com.mysql.cj.jdbc.ClientPreparedStatement"%>
...
<body>
   <div class="container card my-5">
      ...
      <%
      try{
         Class.forName("com.mysql.cj.jdbc.Driver");//1. 드라이버로딩  필요한 코드?
         Connection conn = DriverManager.getConnection(
        		 "jdbc:mysql://localhost:3306/mbasic", //url, 
        		 "root",//user, 
        		 "1234"); //password //2. JDBC 연동   필요한 코드?
        ////////////////////////////////////////////////////////////////////
        PreparedStatement pstmt = 
              conn.prepareStatement("insert into userinfo (name, age) values(?,?)");
     	pstmt.setString(1, "길동"); // ? 순서, 값
      ...
      <%
      try{
       //1. 드라이버로딩  필요한 코드?  Class.forName - com.mysql.nj.jdbc.Driver
       Class.forName("com.mysql.cj.jdbc.Driver");
       
     //2. JDBC 연동   필요한 코드? DriverManager.getConnection    jdbc:myssql://localhost:3306/mbasic
       Connection conn = DriverManager.getConnection(
        		"jdbc:mysql://localhost:3306/mbasic", //url, 
        		"root", //user, 
        		"1234");//password);
       ...
       rset = pstmt.executeQuery();  // 표 - executeQuery - select / executeUpdate - insert, update, delete 
