...
<%@include file="inc/header.jsp" %>
   ...
   <div class="container card my-5">
      ...
      <!-- 1. 처리 : write_action.jsp   2. 데이터 주소표시창줄 노출X   3. 보관용기이름 file이름 -->
      
      <form action="write_action.jsp" method="post" onsubmit="return checkFrom()">
			<div class="my-3">
			...
			<div class="my-3 text_end">
			    ...
			    <a href="list.jsp" class="btn btn-primary" title="글보러가기">목록</a>
