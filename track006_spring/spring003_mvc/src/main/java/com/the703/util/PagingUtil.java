...
public class PagingUtil {
   ...
   private  int  onepagelist;   //#2) 한페이지에 보여줄 게시물의 
   private  int  pagetotal;     //#3) 총페이지수 256/10 = 26 
   ...
   public PagingUtil(int listtotal, int pstartno) { // 전체페이지수, 시작하는 번호 이전 1,2,3,4,5,6,7 ,,,,,,
      super();
      ...
      this.current     = pstartno;     // <이전 11  12    13    14    15(현재)    16   17   18    29    20   다음>
      this.start       = ((this.current-1)/bottomlist) * this.bottomlist +1;  // 15라면 11로 만들기    20라면   11로 만들기
